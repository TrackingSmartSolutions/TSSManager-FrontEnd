...
const SeleccionarActividadModal = ({ isOpen, onClose, onSelectActivity }) => {
    ...
    return (
        <PrincipalModal isOpen={isOpen} onClose={onClose} title="Selecciona el tipo de actividad" size="sm">
...
// Modal para reprogramar reunión con duración en lugar de hora fin
...
const Principal = () => {
    ...
    // Datos estáticos para el gráfico de etapas
    const etapas = [
        "Clasificación",
        "Primer Contacto",
    ...
    // Datos para el gráfico de tratos por usuario
    const tratosPorUsuario = {
        labels: ["Dagoberto Nieto", "Usuario 1", "Usuario 2", "Usuario 3"],
        datasets: [
            {
                label: "Tratos creados",
                data: [25, 18, 15, 12],
                backgroundColor: ["#af86ff", "#38b6ff", "#037ce0", "#0057c9"],
    ...
    // Configuración del gráfico de etapas
    const data = {
        labels: etapas,
        datasets: [
            {
    ...
    const handleSelectActivity = (tipo) => {
        const modalMap = {
            llamada: "reprogramarLlamada",
            reunion: "reprogramarReunion",
            tarea: "reprogramarTarea",
        }
    ...
    // Opciones del gráfico de etapas
    const options = {
        responsive: true,
    ...
    // Opciones para el gráfico de tratos por usuario
    ...
    const usuarios = ["Todos", "Dagoberto Nieto", "Usuario 1", "Usuario 2", "Usuario 3"]
