...
const EquiposCreditosPlataforma = () => {
  ...
  // Agrupar por fecha con subtipos
  const dataByDate = {}
  ...
  return {
    ...
    datasets: [
      {
        label: "Track Solid",
        data: labels.map(fecha => dataByDate[fecha].TRACK_SOLID),
        borderColor: "#6366f1",
      ...
      {
        label: "WhatsGPS Anual",
        data: labels.map(fecha => dataByDate[fecha].WHATSGPS_ANUAL),
        borderColor: "#10b981",
      ...
      {
        label: "WhatsGPS Vitalicia",
        data: labels.map(fecha => dataByDate[fecha].WHATSGPS_VITALICIA),
        borderColor: "#f59e0b",
                        ...
                        {creditosData.estadoCuenta
                          ...
                          .map((registro, index) => (
                            <tr key={index}>
                              ...
                              <td>{registro.plataforma.replace('_', ' ')}</td>
